...
impl Tensor {
    ...
    /// Crée un tenseur CPU avec les données i32 et la forme donnée.
    ...
    /// Crée un tenseur CPU avec les données i64 et la forme donnée.
    ...
    /// Crée un tenseur CPU avec les données bool et la forme donnée.
