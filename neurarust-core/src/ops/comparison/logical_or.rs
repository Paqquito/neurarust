...
/// Effectue un OU logique élément par élément entre deux tenseurs booléens.
/// Le résultat est un tenseur booléen (true si au moins une des entrées est true, false sinon).
