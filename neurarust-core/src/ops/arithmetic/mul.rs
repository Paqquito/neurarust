...
// +++ Helper function - Copied from add.rs - TODO: Move to a shared utils module +++

/// **(Internal Helper - Duplicated)** Reduces a gradient tensor to match a target shape, summing along broadcasted dimensions.
///
/// Refer to the version in `ops/arithmetic/add.rs` or the intended shared location for primary documentation.
/// This function is crucial for handling gradients in operations involving broadcasting.
