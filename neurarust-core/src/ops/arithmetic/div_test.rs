...
mod tests {
    ...
    fn test_div_backward_simple() -> Result<(), GradCheckError> { // Retourne GradCheckError
        ...
        // Utiliser f64 pour epsilon/tolerance car check_grad opère en f64 en interne
        let epsilon = 1e-4; // Augmenter un peu epsilon pour f32 ?
        let tolerance = 1e-4; // Augmenter un peu tolerance pour f32 ?
